...
<span class="bonne">PiecesBonnes:  <input type ="number" name="nb" required></span>
<span class="mauvais">PiecesNQualité:<input type ="number" name="nr" required></span>
