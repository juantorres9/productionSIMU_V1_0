...
STOP:<input id="idnull" type ="text" name="nrebut" required>
...
<p id="idpx"><button type="submit" onclick="setTimeUnix('idnull');setTimeUnix2('idInput3')" value="valider">VALIDER</button></p>
<!--<p><input type="submit"  value="VALIDER"></p>  -->
<!--<p><input type="submit" onmousedown="setTimeUnix('idnull')" value="VALIDER"></p>-->
